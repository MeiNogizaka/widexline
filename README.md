...
MeiNogizaka は、Chrome や Edge の拡張機能ストアに Widexline を公開していません。オリジナルは GitHub のこのリポジトリだけです。第三者がコードを利用して拡張機能として公開しても、中身が同一ではない可能性があります。

![Widexline のタイムライン](widexline_screenshot_1.png)
